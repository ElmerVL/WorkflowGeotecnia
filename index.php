...
<div id="container">
    <div id="header">
        <h1><a href="index.php">Laboratorio de <span>Geotecnia</span></a></h1>
    </div>
        ...
        <div id="content">
            <div>
                <div id="main">
                    ...
                    <form id="ingreso_sistema" name="ingreso_sistema" method="post"
                          action="Controlador/ControladorAccesoUsuarios.php">
                        <div class="text_box" style="padding: 7%;">
                            ...
                            <br/>
                            <input type="submit" class="btn" name="submit" style="margin-left: 10%;" value="Entrar"/>
                    ...
                    <p>
                        ...
                        de mejoramiento de la educación e investigación en el campo de la geotecnia.
                    </p>
                    <ul>
