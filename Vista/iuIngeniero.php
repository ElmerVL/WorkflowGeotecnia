			...
			<div id="main">
				...
				<p>Usted como director puede realizar las siguientes funciones:</p>
                                <ul>
                                    ...
                                    <p>Para proyectos de tipo ensayo de laboratorio:</p>
                                    <ul>
                                        <li><span><a href="../Vista/iuFiltroProyecto.php?f=0&t_p=1">Registrar ensayos para un proyecto</a></span></li>
                                        <li><span><a href="../Vista/iuFiltroProyecto.php?f=1&t_p=1">Registrar muestras para un proyecto</a></span></li>
                                        <li><span><a href="../Vista/iuFiltroProyecto.php?f=2&t_p=1">Ver el detalle de ensayos de un proyecto</a></span></li>
                                        <li><span><a href="../Vista/iuFiltroProyecto.php?f=5&t_p=1">Registrar resultados de un ensayo de laboratorio</a></span></li>
                                    </ul>
                                    <p>Para proyectos de tipo estudio geotécnico:</p>
                                    <ul>
