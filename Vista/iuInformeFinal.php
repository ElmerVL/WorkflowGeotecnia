        ...
        <div id="content"><div>
                <div id="main">
                    ...
                    <ul>
                        ...
                        <br />
                            <form method="post" action="../Controlador/ControladorAprobarInformeFinal.php?i_p=<?php echo $id_proyecto; ?>&t_p=<?php echo $t_proy; ?>&i_f=1" enctype='multipart/form-data'>
                                <br />
                                ...
                                $existen_resultados = false;
                                if (file_exists($dir)) {
                                    $existen_resultados = true;
                                ...
                                if($controlador_proyecto->verificar_informe_aprobado($id_proyecto, $t_proy) == 't') {
                                    echo "<br /><h3>INFORME APROBADO</h3>";
                                } elseif ($existen_resultados){
                                    ?>
                                <input type="submit" class="btn2" name="submit" value="Aprobar" />
                                <?php
                                }
                                ?>
                            </form>
