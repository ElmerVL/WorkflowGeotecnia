...
(function(t) {
    ...
    function s(n, r) {
        ...
        function s() {
            ce = re.theme ? "ui" : "fc", n.addClass("fc"), re.isRTL ? n.addClass("fc-rtl") : n.addClass("fc-ltr"), re.theme && n.addClass("ui-widget"), le = t("<div class='fc-content' />").prependTo(n), ie = new l(ee, re), se = ie.render(), se && n.prepend(se), p(re.defaultView), re.handleWindowResize && t(window).resize(C), h() || d()
        }
        function d() {
            setTimeout(function() {
                !de.start && h() && m()
        ...
        function f() {
            de && (J("viewDestroy", de, de, de.element), de.triggerEventDestroy()), t(window).unbind("resize", C), re.droppable && t(document).off("dragstart", K).off("dragstop", te), de.selectionManagerDestroy && de.selectionManagerDestroy(), ie.destroy(), le.remove(), n.removeClass("fc fc-ltr fc-rtl ui-widget")
        }
        function v() {
            return n.is(":visible")
        }
        ...
        function g(e) {
            be++, de && (J("viewDestroy", de, de, de.element), Y(), de.triggerEventDestroy(), V(), de.element.remove(), ie.deactivateButton(de.name)), ie.activateButton(e), de = new Re[e](t("<div class='fc-view fc-view-" + e + "' />").appendTo(le), ee), m(), X(), be--
        }
        function m(t) {
            de.start && !t && ve.isWithin(de.intervalStart, de.intervalEnd) || v() && y(t)
        }
        function y(t) {
            be++, de.start && (J("viewDestroy", de, de, de.element), Y(), M()), V(), t && (ve = de.incrementDate(ve, t)), de.render(ve.clone()), w(), X(), (de.afterRender || k)(), F(), A(), J("viewRender", de, de, de.element), be--, z()
        }
        function b() {
            v() && (Y(), M(), D(), w(), x())
        }
        function D() {
            fe = re.contentHeight ? re.contentHeight : re.height ? re.height - (se ? se.height() : 0) - T(le) : Math.round(le.width() / Math.max(re.aspectRatio, .5))
        }
        function w() {
            void 0 === fe && D(), be++, de.setHeight(fe), de.setWidth(le.width()), be--, ue = n.outerWidth()
        }
        function C(t) {
            if (!be && t.target === window)
                if (de.start) {
                    var e = ++ye;
                    setTimeout(function() {
                        e == ye && !be && v() && ue != (ue = n.outerWidth()) && (be++, b(), de.trigger("windowResize", me), be--)
                    }, re.windowResizeDelay)
                } else
                    d()
        }
        function E() {
        ...
        function x(t) {
            v() && (de.renderEvents(De, t), de.trigger("eventAfterAllRender"))
        }
        function M() {
            de.triggerEventDestroy(), de.clearEvents(), de.clearEventData()
        }
        function z() {
            !re.lazyFetching || pe(de.start, de.end) ? _() : x()
        }
        function _() {
            ge(de.start, de.end)
        }
        ...
        function F() {
            ie.updateTitle(de.title)
        }
        function A() {
            var t = ee.getNow();
            t.isWithin(de.intervalStart, de.intervalEnd) ? ie.disableButton("today") : ie.enableButton("today")
        }
        function N(t, e) {
            de.select(t, e)
        }
        ...
        function q(t) {
            ve.add(e.duration(t)), m()
        }
        function $() {
            return ve.clone()
        }
        function V() {
            le.css({width: "100%", height: le.height(), overflow: "hidden"})
        }
        function X() {
            le.css({width: "", height: "", overflow: ""})
        }
        function U() {
            return ee
        }
        ...
        function Q(t, e) {
            return void 0 === e ? re[t] : (("height" == t || "contentHeight" == t || "aspectRatio" == t) && (re[t] = e, b()), void 0)
        }
        function J(t, e) {
            return re[t] ? re[t].apply(e || me, Array.prototype.slice.call(arguments, 2)) : void 0
        }
        function K(e, n) {
            var r = e.target, a = t(r);
            if (!a.parents(".fc").length) {
                var o = re.dropAccept;
                (t.isFunction(o) ? o.call(r, a) : a.is(o)) && (he = r, de.dragStart(he, e, n))
            }
        }
        function te(t, e) {
            he && (de.dragStop(he, t, e), he = null)
        }
        var ee = this;
        r = r || {};
        var ne, re = o({}, xe, r);
        ne = re.lang in Me ? Me[re.lang] : Me[xe.lang], ne && (re = o({}, xe, ne, r)), re.isRTL && (re = o({}, xe, ze, ne || {}, r)), ee.options = re, ee.render = i, ee.destroy = f, ee.refetchEvents = E, ee.reportEvents = R, ee.reportEventChange = H, ee.rerenderEvents = S, ee.changeView = p, ee.select = N, ee.unselect = Y, ee.prev = O, ee.next = W, ee.prevYear = L, ee.nextYear = Z, ee.today = P, ee.gotoDate = j, ee.incrementDate = q, ee.getDate = $, ee.getCalendar = U, ee.getView = G, ee.option = Q, ee.trigger = J;
        var ae = u(a(re.lang));
        if (re.monthNames && (ae._months = re.monthNames), re.monthNamesShort && (ae._monthsShort = re.monthNamesShort), re.dayNames && (ae._weekdays = re.dayNames), re.dayNamesShort && (ae._weekdaysShort = re.dayNamesShort), null != re.firstDay) {
            var oe = u(ae._week);
            oe.dow = re.firstDay, ae._week = oe
        }
        ee.defaultAllDayEventDuration = e.duration(re.defaultAllDayEventDuration), ee.defaultTimedEventDuration = e.duration(re.defaultTimedEventDuration), ee.moment = function() {
            var t;
            return"local" === re.timezone ? (t = _e.moment.apply(null, arguments), t.hasTime() && t.local()) : t = "UTC" === re.timezone ? _e.moment.utc.apply(null, arguments) : _e.moment.parseZone.apply(null, arguments), "_locale"in t ? t._locale = ae : t._lang = ae, t
        }, ee.getIsAmbigTimezone = function() {
            return"local" !== re.timezone && "UTC" !== re.timezone
        }, ee.rezoneDate = function(t) {
            return ee.moment(t.toArray())
        }, ee.getNow = function() {
            var t = re.now;
            return"function" == typeof t && (t = t()), ee.moment(t)
        }, ee.calculateWeekNumber = function(t) {
            var e = re.weekNumberCalculation;
            return"function" == typeof e ? e(t) : "local" === e ? t.week() : "ISO" === e.toUpperCase() ? t.isoWeek() : void 0
        }, ee.getEventEnd = function(t) {
            return t.end ? t.end.clone() : ee.getDefaultEventEnd(t.allDay, t.start)
        }, ee.getDefaultEventEnd = function(t, e) {
            var n = e.clone();
            return t ? n.stripTime().add(ee.defaultAllDayEventDuration) : n.add(ee.defaultTimedEventDuration), ee.getIsAmbigTimezone() && n.stripZone(), n
        }, ee.formatRange = function(t, e, n) {
            return"function" == typeof n && (n = n.call(ee, re, ae)), I(t, e, n, null, re.isRTL)
        }, ee.formatDate = function(t, e) {
            return"function" == typeof e && (e = e.call(ee, re, ae)), B(t, e)
        }, c.call(ee, re);
        var ie, se, le, ce, de, ue, fe, ve, he, pe = ee.isFetchNeeded, ge = ee.fetchEvents, me = n[0], ye = 0, be = 0, De = [];
        ve = null != re.defaultDate ? ee.moment(re.defaultDate) : ee.getNow(), re.droppable && t(document).on("dragstart", K).on("dragstop", te)
    }
    function l(e, n) {
        function r() {
            f = n.theme ? "ui" : "fc";
                ...
                t.each(this.split(","), function(r, i) {
                    if ("title" == i)
                        ...
                        if (e[i] ? s = e[i] : Re[i] && (s = function() {
                            ...
                            l = v ? _(v) : c && n.theme ? "<span class='ui-icon ui-icon-" + c + "'></span>" : d && !n.theme ? "<span class='fc-icon fc-icon-" + d + "'></span>" : _(u || i);
    ...
    function c(e) {
        ...
        function s(e) {
            var n, r, a = _e.sourceNormalizers;
        ...
        function p(t, e) {
            var n = D(t);
            n && (n.source || (e && (_.events.push(n), n.source = _), O.push(n)), M(O))
        }
        function g(e) {
            var n, r;
            for (null == e?e = function() {
                ...
                return t._id == n
            }), O = t.grep(O, e, !0), r = 0; R.length > r; r++)
                t.isArray(R[r].events) && (R[r].events = t.grep(R[r].events, e, !0));
            M(O)
        }
        function m(e) {
        ...
        var E, S, k = C.trigger, x = C.getView, M = C.reportEvents, z = C.getEventEnd, _ = {events: []}, R = [_], H = 0, F = 0, A = 0, O = [];
    ...
    function I(t, e, n, r, a) {
        var o;
        return t = _e.moment.parseZone(t), e = _e.moment.parseZone(e), o = (t.localeData || t.lang).call(t), n = o.longDateFormat(n) || n, r = r || " - ", q(t, e, V(n), r, a)
    }
    ...
    function X(t) {
        for (var e, n = [], r = /\[([^\]]*)\]|\(([^\)]*)\)|(LT|(\w)\4*o?)|([^\w\[\(]+)/g; e = r.exec(t); )
            e[1] ? n.push(e[1]) : e[2] ? n.push({maybe: X(e[2])}) : e[3] ? n.push({token: e[3]}) : e[5] && n.push(e[5]);
        return n
    }
    function U(t, e) {
        function n(t, e) {
        ...
        function r(t) {
            a.intervalStart = t.clone().stripTime().startOf("month"), a.intervalEnd = a.intervalStart.clone().add(1, "months"), a.start = a.intervalStart.clone(), a.start = a.skipHiddenDays(a.start), a.start.startOf("week"), a.start = a.skipHiddenDays(a.start), a.end = a.intervalEnd.clone(), a.end = a.skipHiddenDays(a.end, -1, !0), a.end.add((7 - a.end.weekday()) % 7, "days"), a.end = a.skipHiddenDays(a.end, -1, !0);
            var n = Math.ceil(a.end.diff(a.start, "weeks", !0));
            "fixed" == a.opt("weekMode") && (a.end.add(6 - n, "weeks"), n = 6), a.title = e.formatDate(a.intervalStart, a.opt("titleFormat")), a.renderBasic(n, a.getCellsPerWeek(), !0)
        }
        var a = this;
    ...
    function G(t, e) {
        ...
        function r(t) {
            a.intervalStart = t.clone().stripTime().startOf("week"), a.intervalEnd = a.intervalStart.clone().add(1, "weeks"), a.start = a.skipHiddenDays(a.intervalStart), a.end = a.skipHiddenDays(a.intervalEnd, -1, !0), a.title = e.formatRange(a.start, a.end.clone().subtract(1), a.opt("titleFormat"), " — "), a.renderBasic(1, a.getCellsPerWeek(), !1)
        }
        var a = this;
    ...
    function Q(t, e) {
        ...
        function r(t) {
            a.start = a.intervalStart = t.clone().stripTime(), a.end = a.intervalEnd = a.start.clone().add(1, "days"), a.title = e.formatDate(a.start, a.opt("titleFormat")), a.renderBasic(1, 1, !1)
        }
        var a = this;
    ...
    function J(e, n, r) {
        ...
        function c() {
            ...
            for (r += "<thead><tr>", oe && (r += "<th class='fc-week-number " + n + "'>" + _(ie("weekNumberTitle")) + "</th>"), t = 0; G > t; t++)
                e = ue(0, t), r += "<th class='fc-day-header fc-" + Ae[e.day()] + " " + n + "'>" + _(he(e, ae)) + "</th>";
            return r += "</tr></thead>"
        }
        function d() {
            var t, e, n, r = re + "-widget-content", a = "";
            for (a += "<tbody>", t = 0; U > t; t++) {
                for (a += "<tr class='fc-week'>", oe && (n = ue(t, 0), a += "<td class='fc-week-number " + r + "'>" + "<div>" + _(pe(n)) + "</div>" + "</td>"), e = 0; G > e; e++)
                    n = ue(t, e), a += u(n);
                a += "</tr>"
            }
            return a += "</tbody>"
        ...
        function b(t) {
            return t.clone().stripTime().add(1, "days")
        }
        function D(t, e) {
            m(t, e, !0)
        }
        ...
        A.renderBasic = a, A.setHeight = f, A.setWidth = v, A.renderDayOverlay = m, A.defaultSelectionEnd = b, A.renderSelection = D, A.clearSelection = w, A.reportDayClick = C, A.dragStart = E, A.dragStop = S, A.getHoverListener = function() {
            ...
            return!0
        }, A.allDayRow = R, A.getRowCnt = function() {
            return U
    ...
    function te(t, e) {
        ...
        function r(t) {
            a.intervalStart = t.clone().stripTime().startOf("week"), a.intervalEnd = a.intervalStart.clone().add(1, "weeks"), a.start = a.skipHiddenDays(a.intervalStart), a.end = a.skipHiddenDays(a.intervalEnd, -1, !0), a.title = e.formatRange(a.start, a.end.clone().subtract(1), a.opt("titleFormat"), " — "), a.renderAgenda(a.getCellsPerWeek())
        }
        var a = this;
    ...
    function ee(t, e) {
        ...
        function r(t) {
            a.start = a.intervalStart = t.clone().stripTime(), a.end = a.intervalEnd = a.start.clone().add(1, "days"), a.title = e.formatDate(a.start, a.opt("titleFormat")), a.renderAgenda(1)
        }
        var a = this;
    ...
    function ae(n, r, a) {
        ...
        function s() {
            ...
            for (l(), ee = t("<div style='position:absolute;z-index:2;left:0;width:100%'/>").appendTo(n), Le("allDaySlot")?(ne = t("<div class='fc-event-container' style='position:absolute;z-index:8;top:0;left:0'/>").appendTo(ee), r = "<table style='width:100%' class='fc-agenda-allday' cellspacing='0'><tr><th class='" + s + " fc-agenda-axis'>" + (Le("allDayHTML") || _(Le("allDayText"))) + "</th>" + "<td>" + "<div class='fc-day-content'><div style='position:relative'/></div>" + "</td>" + "<th class='" + s + " fc-agenda-gutter'>&nbsp;</th>" + "</tr>" + "</table>", re = t(r).appendTo(ee), ae = re.find("tr"), y(ae.find("td")), ee.append("<div class='fc-agenda-divider " + s + "'>" + "<div class='fc-agenda-divider-inner'/>" + "</div>")):ne = t([]), ie = t("<div style='position:absolute;width:100%;overflow-x:hidden;overflow-y:auto'/>").appendTo(ee), se = t("<div style='position:relative;width:100%;overflow:hidden'/>").appendTo(ie), le = t("<div class='fc-event-container' style='position:absolute;z-index:8;top:0;left:0'/>").appendTo(se), r = "<table class='fc-agenda-slots' style='width:100%' cellspacing='0'><tbody>", a = e.duration( + Ye), Me = 0; Oe > a; )
                o = q.start.clone().time(a), i = o.minutes(), r += "<tr class='fc-slot" + Me + " " + (i ? "fc-minor" : "") + "'>" + "<th class='fc-agenda-axis " + s + "'>" + (d && i ? "&nbsp;" : _(Ge(o, Le("axisFormat")))) + "</th>" + "<td class='" + c + "'>" + "<div style='position:relative'>&nbsp;</div>" + "</td>" + "</tr>", a.add(me), Me++;
        ...
        function d() {
            ...
            for (a += "<thead><tr>", Le("weekNumbers")?(t = Ve(0, 0), e = Qe(t), Ne?e += Le("weekNumberTitle"):e = Le("weekNumberTitle") + e, a += "<th class='fc-agenda-axis fc-week-number " + r + "'>" + _(e) + "</th>"):a += "<th class='fc-agenda-axis " + r + "'>&nbsp;</th>", n = 0; xe > n; n++)
                t = Ve(0, n), a += "<th class='fc-" + Ae[t.day()] + " fc-col" + n + " " + r + "'>" + _(Ge(t, We)) + "</th>";
        ...
        function E(t, e) {
            ...
            for (var n = 0; xe > n; n++) {
                var r = Ve(0, n), a = r.clone().add(1, "days"), o = t > r ? t : r, i = e > a ? a : e;
                if (i > o) {
        ...
        function O(t) {
            return t.hasTime() ? t.clone().add(me) : t.clone().add(1, "days")
        }
        function W(t, e) {
        ...
        var q = this;
        q.renderAgenda = o, q.setWidth = v, q.setHeight = f, q.afterRender = p, q.computeDateTop = N, q.getIsCellAllDay = R, q.allDayRow = function() {
            return ae
        ...
        }), _e = new Ee(ze), Re = new ke(function(t) {
            return Q.eq(t)
    ...
    function oe() {
        ...
        function a(t) {
            ...
            for (n = 0; s > n; n++)
                for (e = R(0, n), i = o(t, e.clone().time(l), e.clone().time(c)), i = ie(i), r = 0; i.length > r; r++)
        ...
        function o(t, e, n) {
            ...
            for (r = 0; f > r; r++)
                a = t[r], o = a.start.clone().stripZone(), i = J(a).stripZone(), i > e && n > o && (e > o ? (s = e.clone(), c = !1) : (s = o, c = !0), i > n ? (l = n.clone(), d = !1) : (l = i, d = !0), u.push({event: a, start: s, end: l, isStart: c, isEnd: d}));
            return u.sort(pe)
        }
        function i(e, n) {
            var r, a, o, i, c, d, u, f, g, m, b, D, w, C, S, x, _ = e.length, R = "", H = E(), F = v("isRTL");
            for (r = 0; _ > r; r++)
                a = e[r], o = a.event, i = k(a.start, a.start), c = k(a.end, a.start), d = M(a.col), u = z(a.col), f = u - d, u -= .025 * f, f = u - d, g = f * (a.forwardCoord - a.backwardCoord), v("slotEventOverlap") && (g = Math.max(2 * (g - 10), g)), F ? (b = u - a.backwardCoord * f, m = b - g) : (m = d + a.backwardCoord * f, b = m + g), m = Math.max(m, d), b = Math.min(b, u), g = b - m, a.top = i, a.left = m, a.outerWidth = g, a.outerHeight = c - i, R += s(o, a);
            for (H[0].innerHTML = R, D = H.children(), r = 0; _ > r; r++)
                a = e[r], o = a.event, w = t(D[r]), C = h("eventRender", o, o, w), C === !1 ? w.remove() : (C && C !== !0 && (w.remove(), w = t(C).css({position: "absolute", top: a.top, left: a.left}).appendTo(H)), a.element = w, o._id === n ? l(o, w, a) : w[0]._fci = r, Z(o, w));
            for (p(H, e, l), r = 0; _ > r; r++)
        ...
        function c(t, n, r) {
            ...
            n.draggable({opacity: v("dragOpacity", "month"), revertDuration: v("dragRevertDuration"), start: function(e, r) {
                    h("eventDragStart", n[0], t, e, r), P(t, n), o = n.width(), d.start(function(e, r) {
                        if ($(), e) {
                            i = !1;
                            var o = R(0, r.col), d = R(0, e.col);
                            s = d.diff(o, "days"), e.row ? l ? c && (n.width(u - 10), m(n, G.defaultTimedEventDuration / p * g), n.draggable("option", "grid", [u, 1]), c = !1) : i = !0 : (q(t.start.clone().add(s, "days"), J(t).add(s, "days")), a()), i = i || c && !s
                        } else
                            a(), i = !0;
                    ...
                    if (d.stop(), $(), h("eventDragStop", n[0], t, r, o), i)
                        ...
                        var l, u, v = t.start.clone().add(s, "days");
        ...
        function d(t, e, n) {
            ...
            e.draggable({scroll: !1, grid: [C, E], axis: 1 == T ? "y" : !1, opacity: v("dragOpacity"), revertDuration: v("dragRevertDuration"), start: function(n, r) {
                    ...
                    (s != l || c != d || u != p || m != y) && (c ? (b = t.start.clone().stripTime().add(g, "days"), D = b.clone().add(G.defaultAllDayEventDuration)) : (b = t.start.clone().add(m * S).add(g, "days"), D = J(t).add(m * S).add(g, "days")), r(), l = s, d = c, p = u, y = m), e.draggable("option", "revert", !s)
                }, stop: function(n, a) {
    ...
    function ge(n, r, a) {
        ...
        function S(t) {
            return H.start.clone().add(t, "days")
        }
        function k(t) {
            var e = x(t), n = M(e), r = _(n);
            return r
        }
        function x(t) {
        ...
        function R(t, e) {
            ...
            for (var l = M(o), c = M(i) - 1, d = 0; n > d; d++) {
                ...
                if (h >= v) {
                    var p = _(v), g = _(h), m = [p.col, g.col].sort(), y = E(v) == o, b = E(h) + 1 == i;
        ...
        }, H.isHiddenDay = b, H.skipHiddenDays = w, H.getCellsPerWeek = D, H.dateToCell = k, H.dateToDayOffset = x, H.dayOffsetToCellOffset = M, H.cellOffsetToCell = _, H.cellToDate = T, H.cellToCellOffset = C, H.cellOffsetToDayOffset = E, H.dayOffsetToDate = S, H.rangeToSegments = R;
    ...
    function me() {
        ...
        function l(t) {
            ...
            var i = A(r, C);
            return e += a ? "<a href='" + _(a) + "'" : "<div", e += " class='" + o.join(" ") + "'" + " style=" + "'" + "position:absolute;" + "left:" + t.left + "px;" + i + "'" + ">" + "<div class='fc-event-inner'>", !r.allDay && t.isStart && (e += "<span class='fc-event-time'>" + _(T.getEventTimeText(r)) + "</span>"), e += "<span class='fc-event-title'>" + _(r.title || "") + "</span>" + "</div>", r.allDay && t.isEnd && k(r) && (e += "<div class='ui-resizable-handle ui-resizable-" + (n ? "w" : "e") + "'>" + "&nbsp;&nbsp;&nbsp;" + "</div>"), e += "</" + (a ? "a" : "div") + ">"
        }
        function c(e, n) {
            for (var r = 0; e.length > r; r++) {
            ...
            e.draggable({delay: 50, opacity: C("dragOpacity"), revertDuration: C("dragRevertDuration"), start: function(o, i) {
                    E("eventDragStart", e[0], t, o, i), F(t, e), a.start(function(a, o, i, s) {
                        if (e.draggable("option", "revert", !a || !i && !s), $(), a) {
                            var l = G(o), c = G(a);
                            n = c.diff(l, "days"), r = t.start.clone().add(n, "days"), q(r, ne(t).add(n, "days"))
                        } else
                            n = 0
                    }, o, "drag")
                }, stop: function(o, i) {
                    a.stop(), $(), E("eventDragStop", e[0], t, o, i), n ? N(e[0], t, r, o, i) : (e.css("filter", ""), R(t, e))
                }})
        }
        function w(e, r, a) {
            ...
            H(r), r.mousedown(function(t) {
                ...
                if (1 == o.which) {
                    ...
                    V(), t("body").css("cursor", i + "-resize").one("mouseup", s), E("eventResizeStart", r[0], e, o, {}), f.start(function(r, o) {
                        if (r) {
                            var s = Q(o), l = Q(r);
                            if (l = Math.max(l, p), c = J(l) - J(s), d = ne(e).add(c, "days"), c) {
                                h.end = d;
                                var f = u;
                                u = n(h, a.row, v), u = t(u), u.find("*").css("cursor", i + "-resize"), f && f.remove(), F(e)
                            } else
                                u && (R(e), u.remove(), u = null);
                            $(), q(e.start, d)
                        }
                    }, o)
                }
        ...
        function o(e) {
            ...
            if (1 == e.which && c("selectable")) {
                ...
                i.start(function(t, e) {
                    v(), t && o(t) ? (d = [n(e), n(t)].sort(x), f(d[0], d[1].clone().add(1, "days"))) : d = null
                }, e), t(document).one("mouseup", function(t) {
                    i.stop(), d && (+d[0] == +d[1] && l(d[0], t), a(d[0], d[1].clone().add(1, "days"), t))
                })
            }
        }
        function i() {
    ...
    }, _e.langs = Me, _e.datepickerLang = function(e, n, r) {
        var a = Me[e];
    ...
    _e.applyAll = N;
    var Ae = ["domingo", "lunes", "martes", "miercoles", "jueves", "viernes", "sábado"], Ne = /^\s*\d{4}-\d\d$/, Ye = /^\s*\d{4}-(?:(\d\d-\d\d)|(W\d\d$)|(W\d\d-\d)|(\d\d\d))((T| )(\d\d(:\d\d(:\d\d(\.\d+)?)?)?)?)?$/;
    _e.moment = function() {
        return O(arguments)
    ...
    Re.month = U, Re.basicWeek = G, Re.basicDay = Q, a({weekMode: "fixed"}), Re.agendaWeek = te, Re.agendaDay = ee, a({allDaySlot: !0, allDayText: "all-day", scrollTime: "06:00:00", slotDuration: "00:30:00", axisFormat: ne, timeFormat: {agenda: re}, dragOpacity: {agenda: .5}, minTime: "00:00:00", maxTime: "24:00:00", slotEventOverlap: !0})
});