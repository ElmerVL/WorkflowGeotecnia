...
<body>
    ...
    <div id="container">
        <div id="header">
            <h1><a href="iuWorkFlow.php">Laboratorio de<span>Geotecnia</span></a></h1>		
        </div>
        ...
        <div id="body">
            ...
            <div id="content"><div>
                    <div id="main">
                        <h2>Administrador</h2>
                        <p>Usted como administrador puede realizar las siguientes funciones:</p>
                        <ul>
                            <li><span><a href="../Vista/iuRegistroUsuarios.php?m=">Registrar usuarios</a></span></li>
                            <li><span><a href="../Vista/iuTablaProyectos.php">Ver la lista de proyectos</a></span></li>
                        </ul>
